...
var tSquareGalleryModule = (function () {
	...
	function putNewProjectForm() {
		var newProjectFormDiv = $("<div class='formCover'> <div id='newProjectFormDiv'> <form id='addProjectForm' action='projects/new' method='POST'><label for='newProject'>New Project Name:</label><input id='newProjectName' type='text'><br><br><input id='submit' value='Add Project' type='submit'></form> </div></div>");
